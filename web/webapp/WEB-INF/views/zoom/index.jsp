...
//         })
    ...
    <script src="${cPath }/resources/js/zoom/tool.js"></script>
    <script src="${cPath }/resources/js/zoom/vconsole.min.js"></script>
<%--     <script src="${cPath }/WEB-INF/views/zoom/index.js"></script> --%>
...
window.addEventListener('DOMContentLoaded', function(event) {
	...
	function websdkready() {
	  ...
	  var API_KEY = "JG3-vT6ITVaUm75MSB60Nw";
	  /**
	   * NEVER PUT YOUR ACTUAL API SECRET IN CLIENT SIDE CODE, THIS IS JUST FOR QUICK PROTOTYPING
	   * The below generateSignature should be done server side as not to expose your api secret in public
	   * You can find an eaxmple in here: https://marketplace.zoom.us/docs/sdk/native-sdks/web/essential/signature
	   */
	  var API_SECRET = "SZGe1XKIEhyxGRn71o6WOIF5eAtHdgNoqTnz";
	    ...
	    .addEventListener("click", function (e) {
	      ...
	      var signature = ZoomMtg.generateSignature({
	        ...
	        success: function (res) {
	          ...
	          var joinUrl = "${cPath}/zoom/meeting.do?"
