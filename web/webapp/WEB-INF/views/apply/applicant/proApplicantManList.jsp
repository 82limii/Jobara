             ...
             <div class="card-body">
		        <h3>해당 공고</h3><br>
				 <table class="table table-bordered">
					...
					<tbody>
						<tr>
							<td>${proapp.probTitle }</td>
							<td>${proapp.probRstartd }</td>
							<td>${proapp.probRendd }</td>
							<td>${proapp.probDeptCd }</td>
						</tr>
					</tbody>
				</table>
	        </div>
...
let listBody = $("#listBody").on("click", "tr", function(){
	...
	if(resume)
		location.href = CONTEXTPATH+"/applicant/com/proApplicantView.do?what="+resume.reSn;
});
