...
public class ScrapPostRetrieveController {
	@Inject
	...
	public String list(
		...
		return "scrap/scrapPost";
	}
	
	@RequestMapping(value="scrapPost.do", produces=MediaType.APPLICATION_JSON_UTF8_VALUE)
	public String listToJson(
			...
			service.retrieveScrapPostList(paging);
